...
void sys_render_update_shot(TEntity *shot){
   PutSprite(shot_plane,shot_pattern,shot->x,shot->y,0);
}
...
void sys_render_update_object_divan1(TEntity *divan){
    PutSprite(divan->plane,object_divan1_pattern,divan->x,divan->y,0);
}
